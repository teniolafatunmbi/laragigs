<x-layout>
    ...
    <script>
        function createGig() {
            const btn = document.getElementById("create-gig");
            // btn.classList.add('flex')
            btn.innerHTML = '<p class="flex">\
                                <svg class="animate-spin h-5 w-5 mr-3 ..." viewBox="0 0 24 24" stroke="white">\
                                    <circle cx="10" cy="10" r="10" fill="none"></circle>\
                                </svg>\ Processing \
                            </p>'
        }
    </script>